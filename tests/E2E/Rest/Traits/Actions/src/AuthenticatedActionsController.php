...
{
    use \Platform\Rest\Traits\Actions\Authenticated\CountAction;
    use \Platform\Rest\Traits\Actions\Authenticated\CreateAction;
    use \Platform\Rest\Traits\Actions\Authenticated\DeleteAction;
    use \Platform\Rest\Traits\Actions\Authenticated\FindAction;
    use \Platform\Rest\Traits\Actions\Authenticated\FindOneAction;
    use \Platform\Rest\Traits\Actions\Authenticated\IdsAction;
    use \Platform\Rest\Traits\Actions\Authenticated\UpdateAction;
    use \Platform\Rest\Traits\Actions\Authenticated\PatchAction;
